...
public class ABVideoRangeSlider: UIView {
    ...
    var startTimeView = ABTimeView()
    var endTimeView = ABTimeView()
    ...
    private func setup() {
        ...
        startIndicator = ABStartIndicator(frame: CGRect(x: 0, y: -topBorderHeight,
                                                        width: 20,
        ...
        progressIndicator = ABProgressIndicator(frame: CGRect(x: 0,
                                                              y: -topBorderHeight + topBorderHeight,
                                                              width: 10,
    ...
    public func setProgressIndicatorImage(image: UIImage, width: CGFloat){
        self.progressIndicator.imageView.image = image
        self.progressIndicator.frame = CGRect(origin: self.progressIndicator.frame.origin, size: CGSize(width: width, height: self.progressIndicator.frame.height))
    }
    ...
    func setTimeView(view: ABTimeView){
